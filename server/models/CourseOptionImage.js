...
const courseOptionImageSchema = new Schema({
  ...
  timestamps: true,
  collection: 'courseoptionimages'                    // Explicit collection name
});

module.exports = model('CourseOptionImage', courseOptionImageSchema);