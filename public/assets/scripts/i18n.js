...
const translations = {
  en: {
    ...
    'wedding:hero.description2': 'This site is your hub for everything wedding-related. Log in with the email you use to RSVP to confirm your guest list and names, choose your menu and dietary needs, see the full schedule, browse our gift registry and chat with other guests — even in private conversations the bride and groom can’t see.',
  ...
  es: {
    ...
    'wedding:hero.description2': 'Esta web será vuestro centro de la boda. Iniciad sesión con el mismo correo del RSVP para confirmar cuántos venís y vuestros nombres, elegir menú y restricciones alimentarias, ver el programa, consultar la lista de regalos y chatear con otros invitados, incluso en conversaciones privadas que los novios no verán.',
  ...
  fr: {
    ...
    'wedding:hero.description2': 'Ce site est votre espace mariage. Connectez-vous avec l’e-mail utilisé pour le RSVP pour confirmer le nombre d’invités et leurs noms, choisir votre menu et vos contraintes alimentaires, voir le programme, consulter notre liste de cadeaux et discuter avec les autres invités, y compris dans des conversations privées invisibles pour les mariés.',
