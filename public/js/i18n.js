...
const translations = {
  en: {
    ...
    'guests:courseGroupLateNightSnacks': 'Late Night Snacks',
    ...
    'guests:gifts.card.insideImageAlt': 'Iluminada and George on the front of the honeymoon card',
    'guests:gifts.card.previewFront': 'Honeymoon card front',
    'guests:gifts.card.previewInside': 'Honeymoon card inside',
    ...
    'guests:gifts.card.frontCaption': 'A wedding gift for you …',
    'guests:gifts.card.insertAttachedLabel': 'Honeymoon card attached here',
    'guests:gifts.card.insertPreviewLabel': 'Honeymoon card preview',
    'guests:gifts.card.insertPreviewFront': 'Honeymoon card front',
    'guests:gifts.card.insertPreviewBack': 'Honeymoon card back',
    'guests:gifts.giftNote.showButton': 'Show gift note',
    'guests:gifts.giftNote.previewFront': 'Gift note front',
    'guests:gifts.giftNote.previewInside': 'Gift note inside',
    'guests:gifts.giftNote.honeymoonWish': 'We hope our contribution to your honeymoon fund helps make your voyage truly memorable.',
    'guests:gifts.giftNote.dialogTitle': 'The gift note that goes with this',
    'guests:gifts.giftNote.title.cash': 'Here\'s your Honeymoon Card',
    'guests:gifts.giftNote.title.cube': 'Here\'s a block for the Wedding Sculpture',
    'guests:gifts.giftNote.title.figurine': 'Here\'s a figurine for the Wedding Cake and Wedding Sculpture',
    'guests:gifts.giftNote.deliveryNote': 'This note will be on your table on the wedding day, ready for you to sign and pass to the bride and groom together with your gift.',
    'guests:gifts.giftNote.messageLabel': 'A personal message',
    'guests:gifts.giftNote.fromLabel': 'From',
    'guests:gifts.giftNote.amountLabel': 'Amount',
    'guests:gifts.giftNote.handwriteHint': 'Space for you to add a few words by hand on the day.',
    ...
    'admin:guests.printList': 'Print List',
    'admin:guestPrint.title': 'Guest List',
    'admin:guestPrint.generated': 'Generated',
    'admin:guestPrint.print': 'Print',
    'admin:guestPrint.name': 'Name',
    'admin:guestPrint.party': 'Party',
    'admin:guestPrint.email': 'Email',
    'admin:guestPrint.child': 'Child',
    'admin:guestPrint.pre': 'Pre',
    'admin:guestPrint.day': 'Day',
    'admin:guestPrint.post': 'Post',
    'admin:guestPrint.rsvp': 'RSVP',
    'admin:guestPrint.unnamed': '???',
    'admin:guestPrint.menu': 'Menu',
    'admin:guestPrint.allergy': 'Allergy',
    'admin:guestPrint.totalPeople': 'Total: {{count}} people in {{parties}} parties',
    'admin:guestPrint.children': 'Children: {{count}}',
    'admin:guestPrint.rsvpd': "RSVP'd: {{count}}",
    ...
    'admin:menu.option.welcome_cocktails': 'Welcome Cocktails',
    'admin:menu.option.starter': 'Starter',
    'admin:menu.option.main': 'Main Course',
    'admin:menu.option.dessert': 'Dessert',
    'admin:menu.option.late_night_snacks': 'Late Night Snacks',
    ...
    'admin:menu.field.isVegan': 'Vegan',
    ...
    'admin:menu.field.helpVegan': 'This option is vegan - free from all animal products',
    ...
    'admin:settings.seating': 'Seating Plan',
    'admin:settings.seatingDesc': 'Show the seating plan tab inside the menu page',
    ...
    'admin:subtab.cashPurchases': 'Cash Purchases',
    'admin:cashPurchases.title': 'Cash Gift Purchases',
    'admin:cashPurchases.add': 'Record cash purchase',
    'admin:cashPurchases.empty': 'No cash purchases recorded yet.',
    'admin:cashPurchases.totalCash': 'Total cash',
    'admin:cashPurchases.deleteTitle': 'Delete this cash purchase',
    'admin:cashPurchases.deleteConfirm': 'Delete this cash purchase? This cannot be undone.',
    'admin:cashPurchases.deleted': 'Cash purchase deleted',
    'admin:cashPurchases.created': 'Cash purchase recorded',
    'admin:cashPurchases.col.guest': 'Guest',
    'admin:cashPurchases.col.gift': 'Gift',
    'admin:cashPurchases.col.amount': 'Amount',
    'admin:cashPurchases.col.date': 'Date',
    'admin:cashPurchases.col.from': 'From',
    'admin:cashPurchases.col.message': 'Message',
    'admin:cashPurchases.col.actions': 'Actions',
    'admin:cashPurchases.col.paymentMethod': 'Payment',
    'admin:cashPurchases.badgeCash': 'Cash',
    'admin:cashPurchases.badgeCard': 'Card',
    'admin:cashPurchases.dialog.title': 'Record a cash gift purchase',
    'admin:cashPurchases.dialog.submit': 'Confirm purchase',
    'admin:cashPurchases.field.guest': 'Guest',
    'admin:cashPurchases.field.guestPlaceholder': 'Start typing a guest name or email…',
    'admin:cashPurchases.field.guestNone': 'No matching guest found.',
    'admin:cashPurchases.field.guestSelected': 'Selected guest',
    'admin:cashPurchases.field.from': 'From (printed on the gift note)',
    'admin:cashPurchases.field.fromHelp': 'Defaults to the guest\'s party member names. Edit if needed.',
    'admin:cashPurchases.field.giftType': 'Gift type',
    'admin:cashPurchases.field.giftTypePlaceholder': '— pick a gift type —',
    'admin:cashPurchases.field.gift': 'Gift',
    'admin:cashPurchases.field.giftPlaceholder': '— pick a gift —',
    'admin:cashPurchases.field.giftNoneAvailable': 'No gifts of this type are currently available.',
    'admin:cashPurchases.field.amount': 'Amount',
    'admin:cashPurchases.field.amountOther': 'Other',
    'admin:cashPurchases.field.amountCustomHint': 'Enter a custom integer amount greater than',
    'admin:cashPurchases.field.message': 'Message (optional)',
    'admin:cashPurchases.giftType.cash': 'Honeymoon card',
    'admin:cashPurchases.giftType.cube': 'Block',
    'admin:cashPurchases.giftType.figurine': 'Figurine',
    'admin:cashPurchases.errorIncomplete': 'Please complete all required fields before confirming.',
    'admin:cashPurchases.errorSubmit': 'Could not record the purchase. Please try again.',
    'admin:gifts.revenue.cash': 'Cash revenue',
    'admin:gifts.revenue.card': 'Card revenue',
    'admin:gifts.revenue.total': 'Total revenue',
    ...
    'admin:tables.party': 'Party',
    'admin:tables.partyMember': 'Party Member',
'admin:tables.currentTable': 'Current Table',
  'admin:tables.action': 'Action',
  'admin:tables.tableAssignment': 'Table Assignment',
    'admin:attendance.event': 'Event',
    'admin:attendance.attending': 'Attending',
    'admin:attendance.noEvents': 'No events configured',
    'admin:attendance.checklist': 'Guest Attendance Checklist',
    'admin:attendance.name': 'Name',
    'admin:attendance.party': 'Party',
    'admin:attendance.saved': 'Saved',
    'admin:attendance.error': 'Error saving',
    'admin:attendance.filterPlaceholder': 'Filter by name...',
    'admin:guests.actionRequired': 'Action Required',
    'admin:guests.withoutMenuChoices.singular': 'guest attending the ceremony without a menu choice',
    'admin:guests.withoutMenuChoices.plural': 'guests attending the ceremony without menu choices',
    'admin:guests.withoutEventResponses.singular': 'guest without event responses',
    'admin:guests.withoutEventResponses.plural': 'guests without event responses',
    'admin:guests.withoutPartyMembers.singular': 'guest without party members',
    'admin:guests.withoutPartyMembers.plural': 'guests without party members',
    'admin:menuResponses.progress': '{done} of {total} ceremony attendees have made menu choices · {pending} still pending',
    'admin:menuNoChoices.partyOf': 'in the party of',
    ...
    'admin:tables.printBanquet': 'Print Seating',
    'admin:tables.venueAccess': 'Venue Access',
    'admin:banquetPrint.title': 'Banquet Seating Plan',
    'admin:banquetPrint.generated': 'Generated',
    'admin:banquetPrint.seat': 'Seat',
    'admin:banquetPrint.allergy': 'Allergy',
    'admin:banquetPrint.seats': 'seats',
    'admin:banquetPrint.print': 'Print',
    'admin:banquetPrint.table': 'Table',
  ...
  es: {
    ...
    'guests:courseGroupLateNightSnacks': 'Snacks Nocturnos',
    ...
    'guests:gifts.card.insideImageAlt': 'Iluminada y George en la portada de la tarjeta de luna de miel',
    'guests:gifts.card.previewFront': 'Portada de la tarjeta de luna de miel',
    'guests:gifts.card.previewInside': 'Interior de la tarjeta de luna de miel',
    ...
    'guests:gifts.card.insertPreviewBack': 'Reverso de la tarjeta de luna de miel',
    'guests:gifts.giftNote.showButton': 'Ver la nota de regalo',
    'guests:gifts.giftNote.previewFront': 'Portada de la nota de regalo',
    ...
    'guests:gifts.giftNote.handwriteHint': 'Espacio para que añadas unas líneas a mano el día de la boda.',
    ...
    'admin:guests.printList': 'Imprimir lista',
    'admin:guestPrint.title': 'Lista de Invitados',
    'admin:guestPrint.generated': 'Generado',
    'admin:guestPrint.print': 'Imprimir',
    'admin:guestPrint.name': 'Nombre',
    'admin:guestPrint.party': 'Grupo',
    'admin:guestPrint.email': 'Email',
    'admin:guestPrint.child': 'Niño',
    'admin:guestPrint.pre': 'Pre',
    'admin:guestPrint.day': 'Día',
    'admin:guestPrint.post': 'Post',
    'admin:guestPrint.rsvp': 'RSVP',
    'admin:guestPrint.unnamed': '???',
    'admin:guestPrint.menu': 'Menú',
    'admin:guestPrint.allergy': 'Alergia',
    'admin:guestPrint.totalPeople': 'Total: {{count}} personas en {{parties}} grupos',
    'admin:guestPrint.children': 'Niños: {{count}}',
    'admin:guestPrint.rsvpd': 'Confirmados: {{count}}',
    ...
    'admin:menu.courseType.welcome_cocktails': 'Cóctel de Bienvenida',
    ...
    'admin:menu.courseType.late_night_snacks': 'Snacks Nocturnos',
    ...
    'admin:menu.option.welcome_cocktails': 'Cóctel de Bienvenida',
    'admin:menu.option.starter': 'Entrante',
    'admin:menu.option.main': 'Plato principal',
    'admin:menu.option.dessert': 'Postre',
    'admin:menu.option.late_night_snacks': 'Snacks Nocturnos',
    ...
    'admin:menu.field.isVegan': 'Vegano',
    ...
    'admin:menu.field.helpVegan': 'Esta opción es vegana - libre de todos los productos animales',
    ...
    'admin:settings.seating': 'Plano de mesas',
    'admin:settings.seatingDesc': 'Mostrar la pestaña del plano de mesas dentro del menú',
    ...
    'admin:subtab.cashPurchases': 'Compras en efectivo',
    'admin:cashPurchases.title': 'Regalos pagados en efectivo',
    'admin:cashPurchases.add': 'Registrar compra en efectivo',
    'admin:cashPurchases.empty': 'Todavía no se han registrado compras en efectivo.',
    'admin:cashPurchases.totalCash': 'Total efectivo',
    'admin:cashPurchases.deleteTitle': 'Eliminar esta compra en efectivo',
    'admin:cashPurchases.deleteConfirm': '¿Eliminar esta compra en efectivo? Esta acción no se puede deshacer.',
    'admin:cashPurchases.deleted': 'Compra en efectivo eliminada',
    'admin:cashPurchases.created': 'Compra en efectivo registrada',
    'admin:cashPurchases.col.guest': 'Invitado',
    'admin:cashPurchases.col.gift': 'Regalo',
    'admin:cashPurchases.col.amount': 'Importe',
    'admin:cashPurchases.col.date': 'Fecha',
    'admin:cashPurchases.col.from': 'De',
    'admin:cashPurchases.col.message': 'Mensaje',
    'admin:cashPurchases.col.actions': 'Acciones',
    'admin:cashPurchases.col.paymentMethod': 'Pago',
    'admin:cashPurchases.badgeCash': 'Efectivo',
    'admin:cashPurchases.badgeCard': 'Tarjeta',
    'admin:cashPurchases.dialog.title': 'Registrar un regalo pagado en efectivo',
    'admin:cashPurchases.dialog.submit': 'Confirmar compra',
    'admin:cashPurchases.field.guest': 'Invitado',
    'admin:cashPurchases.field.guestPlaceholder': 'Escribe un nombre o correo de invitado…',
    'admin:cashPurchases.field.guestNone': 'No se ha encontrado ningún invitado.',
    'admin:cashPurchases.field.guestSelected': 'Invitado seleccionado',
    'admin:cashPurchases.field.from': 'De parte de (impreso en la nota de regalo)',
    'admin:cashPurchases.field.fromHelp': 'Por defecto incluye los nombres del grupo del invitado. Edítalo si lo necesitas.',
    'admin:cashPurchases.field.giftType': 'Tipo de regalo',
    'admin:cashPurchases.field.giftTypePlaceholder': '— elige un tipo de regalo —',
    'admin:cashPurchases.field.gift': 'Regalo',
    'admin:cashPurchases.field.giftPlaceholder': '— elige un regalo —',
    'admin:cashPurchases.field.giftNoneAvailable': 'No hay regalos disponibles de este tipo.',
    'admin:cashPurchases.field.amount': 'Importe',
    'admin:cashPurchases.field.amountOther': 'Otro',
    'admin:cashPurchases.field.amountCustomHint': 'Introduce un importe entero superior a',
    'admin:cashPurchases.field.message': 'Mensaje (opcional)',
    'admin:cashPurchases.giftType.cash': 'Tarjeta de luna de miel',
    'admin:cashPurchases.giftType.cube': 'Bloque',
    'admin:cashPurchases.giftType.figurine': 'Figurita',
    'admin:cashPurchases.errorIncomplete': 'Por favor, completa todos los campos obligatorios antes de confirmar.',
    'admin:cashPurchases.errorSubmit': 'No se ha podido registrar la compra. Inténtalo de nuevo.',
    'admin:gifts.revenue.cash': 'Ingresos en efectivo',
    'admin:gifts.revenue.card': 'Ingresos con tarjeta',
    'admin:gifts.revenue.total': 'Ingresos totales',
    ...
    'admin:tables.party': 'Grupo',
    'admin:tables.partyMember': 'Miembro del Grupo',
'admin:tables.currentTable': 'Mesa Actual',
  'admin:tables.action': 'Acción',
  'admin:tables.tableAssignment': 'Asignación de Mesa',
    'admin:attendance.event': 'Evento',
    'admin:attendance.attending': 'Asistentes',
    'admin:attendance.noEvents': 'No hay eventos configurados',
    'admin:attendance.checklist': 'Lista de Asistencia de Invitados',
    'admin:attendance.name': 'Nombre',
    'admin:attendance.party': 'Grupo',
    'admin:attendance.saved': 'Guardado',
    'admin:attendance.error': 'Error al guardar',
    'admin:attendance.filterPlaceholder': 'Filtrar por nombre...',
    'admin:guests.actionRequired': 'Acción Requerida',
    'admin:guests.withoutMenuChoices.singular': 'invitado que asiste a la ceremonia sin selección de menú',
    'admin:guests.withoutMenuChoices.plural': 'invitados que asisten a la ceremonia sin selección de menú',
    'admin:guests.withoutEventResponses.singular': 'invitado sin respuesta a los eventos',
    'admin:guests.withoutEventResponses.plural': 'invitados sin respuestas a los eventos',
    'admin:guests.withoutPartyMembers.singular': 'invitado sin acompañantes',
    'admin:guests.withoutPartyMembers.plural': 'invitados sin acompañantes',
    'admin:menuResponses.progress': '{done} de {total} asistentes a la ceremonia han elegido menú · {pending} pendientes',
    'admin:menuNoChoices.partyOf': 'del grupo de',
    ...
    'admin:tables.printBanquet': 'Imprimir asientos',
    'admin:tables.venueAccess': 'Acceso del Local',
    'admin:banquetPrint.title': 'Plan de Asientos del Banquete',
    'admin:banquetPrint.generated': 'Generado',
    'admin:banquetPrint.seat': 'Asiento',
    'admin:banquetPrint.allergy': 'Alergia',
    'admin:banquetPrint.seats': 'asientos',
    'admin:banquetPrint.print': 'Imprimir',
    'admin:banquetPrint.table': 'Mesa',
  ...
  fr: {
    ...
    'guests:courseGroupDesserts': 'Desserts',
    'guests:courseGroupLateNightSnacks': 'Collations de Nuit',
    ...
    'guests:gifts.card.insideImageAlt': 'Iluminada et George sur le recto de la carte lune de miel',
    'guests:gifts.card.previewFront': 'Recto de la carte lune de miel',
    'guests:gifts.card.previewInside': 'Intérieur de la carte lune de miel',
    ...
    'guests:gifts.card.frontCaption': 'Un cadeau de mariage pour vous …',
    'guests:gifts.card.insertAttachedLabel': 'Carte lune de miel fixée ici',
    'guests:gifts.card.insertPreviewLabel': 'Aperçu de la carte lune de miel',
    'guests:gifts.card.insertPreviewFront': 'Recto de la carte lune de miel',
    'guests:gifts.card.insertPreviewBack': 'Verso de la carte lune de miel',
    'guests:gifts.giftNote.showButton': 'Voir le mot d’accompagnement',
    'guests:gifts.giftNote.previewFront': 'Recto du mot d’accompagnement',
    'guests:gifts.giftNote.previewInside': 'Intérieur du mot d’accompagnement',
    'guests:gifts.giftNote.honeymoonWish': 'Nous espérons que notre contribution à votre cagnotte lune de miel rendra votre voyage vraiment inoubliable.',
    'guests:gifts.giftNote.dialogTitle': 'Le mot d’accompagnement qui ira avec ce cadeau',
    'guests:gifts.giftNote.title.cash': 'Voici votre carte lune de miel',
    'guests:gifts.giftNote.title.cube': 'Voici un bloc pour la sculpture du mariage',
    'guests:gifts.giftNote.title.figurine': 'Voici une figurine pour la pièce montée et la sculpture',
    'guests:gifts.giftNote.deliveryNote': 'Ce mot sera sur votre table le jour du mariage, prêt à être signé et remis aux mariés en même temps que votre cadeau.',
    'guests:gifts.giftNote.messageLabel': 'Message personnel',
    'guests:gifts.giftNote.fromLabel': 'De',
    'guests:gifts.giftNote.amountLabel': 'Montant',
    'guests:gifts.giftNote.handwriteHint': 'Espace pour ajouter quelques mots à la main le jour J.',
    ...
    'admin:guests.printList': 'Imprimer la liste',
    'admin:guestPrint.title': 'Liste des Invités',
    'admin:guestPrint.generated': 'Généré',
    'admin:guestPrint.print': 'Imprimer',
    'admin:guestPrint.name': 'Nom',
    'admin:guestPrint.party': 'Groupe',
    'admin:guestPrint.email': 'Email',
    'admin:guestPrint.child': 'Enfant',
    'admin:guestPrint.pre': 'Pré',
    'admin:guestPrint.day': 'Jour',
    'admin:guestPrint.post': 'Post',
    'admin:guestPrint.rsvp': 'RSVP',
    'admin:guestPrint.unnamed': '???',
    'admin:guestPrint.menu': 'Menu',
    'admin:guestPrint.allergy': 'Allergie',
    'admin:guestPrint.totalPeople': 'Total : {{count}} personnes en {{parties}} groupes',
    'admin:guestPrint.children': 'Enfants : {{count}}',
    'admin:guestPrint.rsvpd': 'Confirmés : {{count}}',
    'admin:guests.table.email': 'Email',
    ...
    'admin:menu.courseType.welcome_cocktails': 'Cocktail de Bienvenue',
    'admin:menu.courseType.starter': 'Entrées',
    'admin:menu.courseType.main': 'Plats principaux',
    'admin:menu.courseType.dessert': 'Desserts',
    'admin:menu.courseType.late_night_snacks': 'Collations de Nuit',
    ...
    'admin:menu.option.welcome_cocktails': 'Cocktail de Bienvenue',
    'admin:menu.option.starter': 'Entrée',
    'admin:menu.option.main': 'Plat principal',
    'admin:menu.option.dessert': 'Dessert',
    'admin:menu.option.late_night_snacks': 'Collations de Nuit',
    ...
    'admin:menu.field.isVegan': 'Végétalien',
    ...
    'admin:menu.field.helpVegan': 'Cette option est végétalienne - sans aucun produit animal',
    ...
    'admin:settings.seating': 'Plan de table',
    'admin:settings.seatingDesc': 'Afficher l’onglet plan de table dans la page du menu',
    'admin:settings.messages': 'Messages',
    ...
    'admin:subtab.cashPurchases': 'Achats en espèces',
    'admin:cashPurchases.title': 'Cadeaux payés en espèces',
    'admin:cashPurchases.add': 'Enregistrer un achat en espèces',
    'admin:cashPurchases.empty': 'Aucun achat en espèces enregistré pour l\'instant.',
    'admin:cashPurchases.totalCash': 'Total espèces',
    'admin:cashPurchases.deleteTitle': 'Supprimer cet achat en espèces',
    'admin:cashPurchases.deleteConfirm': 'Supprimer cet achat en espèces ? Cette action ne peut pas être annulée.',
    'admin:cashPurchases.deleted': 'Achat en espèces supprimé',
    'admin:cashPurchases.created': 'Achat en espèces enregistré',
    'admin:cashPurchases.col.guest': 'Invité',
    'admin:cashPurchases.col.gift': 'Cadeau',
    'admin:cashPurchases.col.amount': 'Montant',
    'admin:cashPurchases.col.date': 'Date',
    'admin:cashPurchases.col.from': 'De',
    'admin:cashPurchases.col.message': 'Message',
    'admin:cashPurchases.col.actions': 'Actions',
    'admin:cashPurchases.col.paymentMethod': 'Paiement',
    'admin:cashPurchases.badgeCash': 'Espèces',
    'admin:cashPurchases.badgeCard': 'Carte',
    'admin:cashPurchases.dialog.title': 'Enregistrer un cadeau payé en espèces',
    'admin:cashPurchases.dialog.submit': 'Confirmer l\'achat',
    'admin:cashPurchases.field.guest': 'Invité',
    'admin:cashPurchases.field.guestPlaceholder': 'Commencez à taper un nom ou un e-mail…',
    'admin:cashPurchases.field.guestNone': 'Aucun invité correspondant.',
    'admin:cashPurchases.field.guestSelected': 'Invité sélectionné',
    'admin:cashPurchases.field.from': 'De la part de (imprimé sur le mot d\'accompagnement)',
    'admin:cashPurchases.field.fromHelp': 'Par défaut, les noms du groupe de l\'invité. Modifiez si nécessaire.',
    'admin:cashPurchases.field.giftType': 'Type de cadeau',
    'admin:cashPurchases.field.giftTypePlaceholder': '— choisissez un type de cadeau —',
    'admin:cashPurchases.field.gift': 'Cadeau',
    'admin:cashPurchases.field.giftPlaceholder': '— choisissez un cadeau —',
    'admin:cashPurchases.field.giftNoneAvailable': 'Aucun cadeau de ce type disponible.',
    'admin:cashPurchases.field.amount': 'Montant',
    'admin:cashPurchases.field.amountOther': 'Autre',
    'admin:cashPurchases.field.amountCustomHint': 'Saisissez un montant entier supérieur à',
    'admin:cashPurchases.field.message': 'Message (facultatif)',
    'admin:cashPurchases.giftType.cash': 'Carte lune de miel',
    'admin:cashPurchases.giftType.cube': 'Bloc',
    'admin:cashPurchases.giftType.figurine': 'Figurine',
    'admin:cashPurchases.errorIncomplete': 'Veuillez remplir tous les champs obligatoires avant de confirmer.',
    'admin:cashPurchases.errorSubmit': 'Impossible d\'enregistrer l\'achat. Veuillez réessayer.',
    'admin:gifts.revenue.cash': 'Revenu en espèces',
    'admin:gifts.revenue.card': 'Revenu par carte',
    'admin:gifts.revenue.total': 'Revenu total',
...
'admin:tables.currentTable': 'Table Actuelle',
  ...
  'admin:tables.tableAssignment': 'Attribution de Table',
    ...
    'admin:attendance.checklist': 'Liste de Présence des Invités',
    'admin:attendance.name': 'Nom',
    'admin:attendance.party': 'Groupe',
    'admin:attendance.saved': 'Enregistré',
    'admin:attendance.error': 'Erreur lors de l\'enregistrement',
    'admin:attendance.filterPlaceholder': 'Filtrer par nom...',
    'admin:guests.actionRequired': 'Action Requise',
    'admin:guests.withoutMenuChoices.singular': 'invité présent à la cérémonie sans choix de menu',
    'admin:guests.withoutMenuChoices.plural': 'invités présents à la cérémonie sans choix de menu',
    'admin:guests.withoutEventResponses.singular': 'invité sans réponse aux événements',
    'admin:guests.withoutEventResponses.plural': 'invités sans réponse aux événements',
    'admin:guests.withoutPartyMembers.singular': 'invité sans accompagnants',
    'admin:guests.withoutPartyMembers.plural': 'invités sans accompagnants',
    'admin:menuResponses.progress': '{done} sur {total} invités à la cérémonie ont fait leur choix de menu · {pending} en attente',
    'admin:menuNoChoices.partyOf': 'du groupe de',
    ...
    'admin:tables.printBanquet': 'Imprimer les places',
    'admin:tables.venueAccess': 'Accès du Lieu',
    'admin:banquetPrint.title': 'Plan de Table du Banquet',
    'admin:banquetPrint.generated': 'Généré',
    'admin:banquetPrint.seat': 'Place',
    'admin:banquetPrint.allergy': 'Allergie',
    'admin:banquetPrint.seats': 'places',
    'admin:banquetPrint.print': 'Imprimer',
    'admin:banquetPrint.table': 'Table',
  ...
  de: {
    ...
    'guests:courseGroupDesserts': 'Desserts',
    'guests:courseGroupLateNightSnacks': 'Spätnacht-Snacks',
    ...
    'guests:gifts.card.insideImageAlt': 'Iluminada und George auf der Vorderseite der Hochzeitsreise-Karte',
    'guests:gifts.card.previewFront': 'Vorderseite der Hochzeitsreise-Karte',
    'guests:gifts.card.previewInside': 'Innenseite der Hochzeitsreise-Karte',
    ...
    'guests:gifts.card.insertPreviewBack': 'Rückseite der Hochzeitsreise-Karte',
    'guests:gifts.giftNote.showButton': 'Geschenkkarte ansehen',
    'guests:gifts.giftNote.previewFront': 'Vorderseite der Geschenkkarte',
    ...
    'guests:gifts.giftNote.handwriteHint': 'Platz für ein paar Worte von Hand am Hochzeitstag.',
    ...
    'admin:guests.printList': 'Liste drucken',
    'admin:guestPrint.title': 'Gästeliste',
    'admin:guestPrint.generated': 'Erstellt',
    'admin:guestPrint.print': 'Drucken',
    'admin:guestPrint.name': 'Name',
    'admin:guestPrint.party': 'Gruppe',
    'admin:guestPrint.email': 'E-Mail',
    'admin:guestPrint.child': 'Kind',
    'admin:guestPrint.pre': 'Vor',
    'admin:guestPrint.day': 'Tag',
    'admin:guestPrint.post': 'Nach',
    'admin:guestPrint.rsvp': 'RSVP',
    'admin:guestPrint.unnamed': '???',
    'admin:guestPrint.menu': 'Menü',
    'admin:guestPrint.allergy': 'Allergie',
    'admin:guestPrint.totalPeople': 'Gesamt: {{count}} Personen in {{parties}} Gruppen',
    'admin:guestPrint.children': 'Kinder: {{count}}',
    'admin:guestPrint.rsvpd': 'Bestätigt: {{count}}',
    ...
    'admin:menu.courseType.welcome_cocktails': 'Willkommenscocktail',
    'admin:menu.courseType.starter': 'Vorspeisen',
    'admin:menu.courseType.main': 'Hauptgerichte',
    'admin:menu.courseType.dessert': 'Desserts',
    'admin:menu.courseType.late_night_snacks': 'Spätnacht-Snacks',
    ...
    'admin:menu.option.welcome_cocktails': 'Willkommenscocktail',
    'admin:menu.option.starter': 'Vorspeise',
    'admin:menu.option.main': 'Hauptgericht',
    'admin:menu.option.dessert': 'Dessert',
    'admin:menu.option.late_night_snacks': 'Spätnacht-Snacks',
    ...
    'admin:menu.field.helpVegan': 'Diese Option ist vegan - frei von allen tierischen Produkten',
    ...
    'admin:settings.seating': 'Sitzplan',
    'admin:settings.seatingDesc': 'Tab Sitzplan innerhalb der Menüseite anzeigen',
    ...
    'admin:subtab.cashPurchases': 'Barzahlungen',
    'admin:cashPurchases.title': 'Geschenke in bar bezahlt',
    'admin:cashPurchases.add': 'Barzahlung erfassen',
    'admin:cashPurchases.empty': 'Noch keine Barzahlungen erfasst.',
    'admin:cashPurchases.totalCash': 'Bar gesamt',
    'admin:cashPurchases.deleteTitle': 'Diese Barzahlung löschen',
    'admin:cashPurchases.deleteConfirm': 'Diese Barzahlung löschen? Dies kann nicht rückgängig gemacht werden.',
    'admin:cashPurchases.deleted': 'Barzahlung gelöscht',
    'admin:cashPurchases.created': 'Barzahlung erfasst',
    'admin:cashPurchases.col.guest': 'Gast',
    'admin:cashPurchases.col.gift': 'Geschenk',
    'admin:cashPurchases.col.amount': 'Betrag',
    'admin:cashPurchases.col.date': 'Datum',
    'admin:cashPurchases.col.from': 'Von',
    'admin:cashPurchases.col.message': 'Nachricht',
    'admin:cashPurchases.col.actions': 'Aktionen',
    'admin:cashPurchases.col.paymentMethod': 'Zahlung',
    'admin:cashPurchases.badgeCash': 'Bar',
    'admin:cashPurchases.badgeCard': 'Karte',
    'admin:cashPurchases.dialog.title': 'Ein in bar bezahltes Geschenk erfassen',
    'admin:cashPurchases.dialog.submit': 'Kauf bestätigen',
    'admin:cashPurchases.field.guest': 'Gast',
    'admin:cashPurchases.field.guestPlaceholder': 'Namen oder E-Mail eines Gastes eingeben…',
    'admin:cashPurchases.field.guestNone': 'Kein passender Gast gefunden.',
    'admin:cashPurchases.field.guestSelected': 'Ausgewählter Gast',
    'admin:cashPurchases.field.from': 'Von (auf der Geschenkkarte gedruckt)',
    'admin:cashPurchases.field.fromHelp': 'Standardmäßig die Namen aus der Gruppe des Gastes. Bei Bedarf anpassen.',
    'admin:cashPurchases.field.giftType': 'Geschenkart',
    'admin:cashPurchases.field.giftTypePlaceholder': '— Geschenkart wählen —',
    'admin:cashPurchases.field.gift': 'Geschenk',
    'admin:cashPurchases.field.giftPlaceholder': '— Geschenk wählen —',
    'admin:cashPurchases.field.giftNoneAvailable': 'Keine Geschenke dieser Art verfügbar.',
    'admin:cashPurchases.field.amount': 'Betrag',
    'admin:cashPurchases.field.amountOther': 'Anderer',
    'admin:cashPurchases.field.amountCustomHint': 'Ganzzahliger Betrag größer als',
    'admin:cashPurchases.field.message': 'Nachricht (optional)',
    'admin:cashPurchases.giftType.cash': 'Hochzeitsreise-Karte',
    'admin:cashPurchases.giftType.cube': 'Block',
    'admin:cashPurchases.giftType.figurine': 'Figur',
    'admin:cashPurchases.errorIncomplete': 'Bitte alle Pflichtfelder ausfüllen, bevor du bestätigst.',
    'admin:cashPurchases.errorSubmit': 'Kauf konnte nicht erfasst werden. Bitte erneut versuchen.',
    'admin:gifts.revenue.cash': 'Einnahmen bar',
    'admin:gifts.revenue.card': 'Einnahmen Karte',
    'admin:gifts.revenue.total': 'Einnahmen gesamt',
...
'admin:tables.currentTable': 'Aktueller Tisch',
  ...
  'admin:tables.tableAssignment': 'Tischzuweisung',
    ...
    'admin:attendance.checklist': 'Anwesenheitsliste der Gäste',
    'admin:attendance.name': 'Name',
    'admin:attendance.party': 'Gruppe',
    'admin:attendance.saved': 'Gespeichert',
    'admin:attendance.error': 'Fehler beim Speichern',
    'admin:attendance.filterPlaceholder': 'Nach Name filtern...',
    'admin:guests.actionRequired': 'Handlungsbedarf',
    'admin:guests.withoutMenuChoices.singular': 'Gast bei der Trauung ohne Menüauswahl',
    'admin:guests.withoutMenuChoices.plural': 'Gäste bei der Trauung ohne Menüauswahl',
    'admin:guests.withoutEventResponses.singular': 'Gast ohne Veranstaltungsantworten',
    'admin:guests.withoutEventResponses.plural': 'Gäste ohne Veranstaltungsantworten',
    'admin:guests.withoutPartyMembers.singular': 'Gast ohne Begleitung',
    'admin:guests.withoutPartyMembers.plural': 'Gäste ohne Begleitung',
    'admin:menuResponses.progress': '{done} von {total} Trauungsgästen haben Menü ausgewählt · {pending} noch offen',
    'admin:menuNoChoices.partyOf': 'aus der Gruppe von',
    ...
    'admin:tables.printBanquet': 'Sitzplan drucken',
    'admin:tables.venueAccess': 'Veranstaltungsort-Zugang',
    'admin:banquetPrint.title': 'Sitzplan des Banketts',
    'admin:banquetPrint.generated': 'Erstellt',
    'admin:banquetPrint.seat': 'Platz',
    'admin:banquetPrint.allergy': 'Allergie',
    'admin:banquetPrint.seats': 'Plätze',
    'admin:banquetPrint.print': 'Drucken',
    'admin:banquetPrint.table': 'Tisch',
