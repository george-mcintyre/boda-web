...
const translations = {
  en: {
    ...
    'guests:eventRSVPDesc': 'Please confirm your attendance.',
  ...
  es: {
    ...
    'guests:eventRSVPDesc': 'Por favor confirma tu asistencia.',
  ...
  fr: {
    ...
    'wedding:hero.description2': 'Ce site est votre espace mariage. Connectez-vous avec l’e-mail utilisé pour le RSVP pour confirmer le name d’invités et leurs noms, choisir votre menu et vos contraintes alimentaires, voir le programme, consulter notre liste de cadeaux et discuter avec les autres invités, y compris dans des conversations privées invisibles pour les mariés.',
    ...
    'guests:eventRSVPDesc': 'Veuillez confirmer votre présence.',
