...
const translations = {
  en: {
    ...
    'rich:common:footer': '© 2026 Boda de Iluminada &amp; George',
    'common:party.primaryGuest': 'Primary Guest',
    'common:adult': 'Adult (18+)',
    'common:child': 'Child',
    'common:members': 'members',
    'common:name': 'Name',
    'common:ageCategory': 'Age Category',
    ...
    'guests:confirmRemoveMember': 'Are you sure you want to remove {{memberName}} from your party?',
  ...
  es: {
    ...
    'rich:common:footer': '© 2026 Boda de Iluminada &amp; George',
    'common:party.primaryGuest': 'Invitado principal',
    'common:adult': 'Adulto (18+)',
    'common:child': 'Niño',
    'common:members': 'miembros',
    'common:name': 'Nombre',
    'common:ageCategory': 'Edad',
    'rich:common:new': '<i class="fas fa-plus-circle"></i> Nuevo',
    'common:removeMember': 'Eliminar miembro',
    'common:enterName': 'Introduce el nombre...', 
    ...
    'common:menuSelectionsSaved': 'Selecciones de menú guardadas correctamente.',
    'common:errorSavingMenuSelections': 'Error al guardar las selecciones de menú',
    'common:menuSelectionSaved': 'Selección de menú guardada correctamente.',
    'common:errorSavingMenuSelection': 'Error al guardar la selección de menú',
    'common:specialRequestSaved': 'Petición especial guardada correctamente.',
    'common:errorSavingSpecialRequest': 'Error al guardar la petición especial',
    'common:specialRequestDetailsSaved': 'Detalles de la petición especial guardados correctamente.',
    'common:errorSavingSpecialRequestDetails': 'Error al guardar los detalles de la petición especial',
    'common:People': 'personas',
    'common:Person': 'persona',
    'guests:confirmRemoveMember': '¿Estás seguro de querer eliminar a {{memberName}} de tu grupo?',
    ...
    'login:enterEmail': 'Por favor, introduce tu correo electrónico.',
    'login:successRedirect': 'Acceso correcto. Redirigiendo...',
    'login:emailNotFound': 'El correo no figura en la lista de invitados',
    ...
    // Party Page
    'guests:partyPageTitle': 'Gestión del grupo',
    'guests:partyPageDescription': 'Gestiona los miembros de tu grupo y sus requisitos dietéticos.',
